...
public class Practice10MatrixSkewView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        matrix.reset();
        matrix.postSkew(0f,0.5f,point1.x+bitmapCenterWidth, point1.y+bitmapCenterHeight);
        ...
        canvas.save();
        matrix.reset();
        matrix.postSkew(-0.5f,0,point2.x+bitmapCenterWidth, point2.y+bitmapCenterHeight);
        canvas.concat(matrix);
