...
public class Practice09MatrixRotateView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        matrix.reset();
        matrix.postRotate(-180,point1.x+bitmapCenterWidth, point1.y+bitmapCenterHeight);
        ...
        canvas.save();
        matrix.reset();
        matrix.postRotate(315,point2.x+bitmapCenterWidth, point2.y+bitmapCenterHeight);
        canvas.concat(matrix);
